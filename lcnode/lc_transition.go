...
type ExtentApi interface {
	...
	Write(inode uint64, offset int, data []byte, flags int, checkFunc func() error, poolId uint8, storageClass uint32, isMigration, waitForFlush bool) (write int, err error)
