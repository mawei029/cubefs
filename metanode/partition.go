...
type OpInode interface {
	...
	UpdateInodeMeta(req *proto.UpdateInodeMetaRequest, p *Packet, remoteAddr string) (err error)
...
type OpExtent interface {
	...
	BatchObjExtentAppendWithCheck(req *proto.AppendObjExtentKeysRequest, p *Packet) (err error)
