...
func formatPeer(peer proto.Peer) string {
	...
	return fmt.Sprintf(peerTableRowPattern, peer.ID, peer.Addr, peer.HeartbeatPort, peer.ReplicaPort, isLearnerStr, manualPromoteStr, peer.Tag)
}
...
func formatDataNodeDetail(dn *proto.DataNodeInfo, rowTable bool) string {
	...
	sb.WriteString(fmt.Sprintf("  PreReserved               : %v\n", formatSize(dn.PreReservedSpace)))
	...
	sb.WriteString(fmt.Sprintf("  PreReservedDp count       : %v\n", dn.PreReservedDpCount))
...
func formatMetaNodeDetail(mn *proto.MetaNodeInfo, rowTable bool) string {
	...
	sb.WriteString(fmt.Sprintf("  Rdonly              : %v\n", mn.RdOnly))
	sb.WriteString(fmt.Sprintf("  RocksdbRdonly       : %v\n", mn.RocksdbRdOnly))
